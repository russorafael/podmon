...
# Version: 1.2.0
# Author: russorafael
# Date: 2025-04-14 10:55:21

# Current system info
CURRENT_DATE = "2025-04-14 10:55:21"
...
class PodMonitor:
    ...
    def setup_cleanup_schedule(self):
        ...
        schedule.every().day.at("00:00").do(self.db.cleanup_old_data, retention_days)
